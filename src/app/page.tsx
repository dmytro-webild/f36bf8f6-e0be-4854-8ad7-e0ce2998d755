...
export default function LandingPage() {
  ...
  <div id="hero" data-section="hero">
      ...
      avatars={[
        ...
        {
          src: "http://img.b2bpic.net/free-photo/portrait-salesman-car-dealership_23-2148130114.jpg",
      ...
      marqueeItems={[
        ...
        {
          type: "text",
          text: "NYS Inspection Experts",
        },
        {
          type: "text",
          text: "Full Engine Service",
        },
        {
          type: "text",
          text: "Trusted Webster Local",
        },
        {
          type: "text",
          text: "Premium Care",
  ...
  <div id="contact" data-section="contact">
      ...
      textarea={{
        name: "message",
        placeholder: "How can we help with your vehicle?",
        rows: 4,
        required: true,
      }}
      ...
      columns={[
        {
          ...
          items: [
            {
              label: "92 E Main St, Webster, NY 14580",
              href: "#",
            },
            {
              label: "(585) 265-3020",
